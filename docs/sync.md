...
Implementation: `com.campusmesh.android.sync.PacketIdUtil`.

## GCS Filter (On-demand)

Implementation: `com.campusmesh.android.sync.GCSFilter`.
...
Encode/Decode implementation: `com.campusmesh.android.model.RequestSyncPacket`.
