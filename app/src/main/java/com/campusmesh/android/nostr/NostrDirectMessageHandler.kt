...
import com.campusmesh.android.services.SeenMessageStore
import com.campusmesh.android.ui.ChatState
import com.campusmesh.android.ui.MeshDelegateHandler
import com.campusmesh.android.ui.PrivateChatManager
...
class NostrDirectMessageHandler(
    ...
    private val dataManager: com.campusmesh.android.ui.DataManager
) {
    ...
    fun onGiftWrap(giftWrap: NostrEvent, geohash: String, identity: NostrIdentity) {
        scope.launch(Dispatchers.Default) {
            try {
                ...
                if (packet.type != com.campusmesh.android.protocol.MessageType.NOISE_ENCRYPTED.value) return@launch
                ...
                com.campusmesh.android.nostr.GeohashAliasRegistry.put(convKey, senderPubkey)
        ...
        when (payload.type) {
            ...
            NoisePayloadType.FILE_TRANSFER -> {
                ...
                if (file != null) {
                    ...
                    val savedPath = com.campusmesh.android.features.file.FileUtils.saveIncomingFile(application, file)
                    val message = BitchatMessage(
                        id = uniqueMsgId,
                        sender = senderNickname,
                        content = savedPath,
