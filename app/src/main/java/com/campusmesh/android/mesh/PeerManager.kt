...
class PeerManager {
    ...
    private val stalePeerTimeoutMs: Long = com.campusmesh.android.util.AppConstants.Mesh.STALE_PEER_TIMEOUT_MS
    ...
    private fun startPeriodicCleanup() {
        managerScope.launch {
            while (isActive) {
                delay(com.campusmesh.android.util.AppConstants.Mesh.PEER_CLEANUP_INTERVAL_MS)
                cleanupStalePeers()
            }
        }
    }
