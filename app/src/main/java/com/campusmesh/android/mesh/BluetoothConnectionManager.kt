...
class BluetoothConnectionManager(
    ...
    private fun isGattServerEnabled(): Boolean {
        return isBleTransportEnabled() &&
            (try { com.campusmesh.android.ui.debug.DebugSettingsManager.getInstance().gattServerEnabled.value } catch (_: Exception) { true })
    }
    ...
    init {
        ...
        try {
            val dbg = com.campusmesh.android.ui.debug.DebugSettingsManager.getInstance()
