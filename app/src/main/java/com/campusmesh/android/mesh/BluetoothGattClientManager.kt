...
import com.campusmesh.android.ui.debug.DebugSettingsManager
import com.campusmesh.android.ui.debug.DebugScanResult
...
class BluetoothGattClientManager(
    ...
    private fun isClientRoleEnabled(): Boolean {
        return isBleTransportEnabled() &&
            (try { com.campusmesh.android.ui.debug.DebugSettingsManager.getInstance().gattClientEnabled.value } catch (_: Exception) { true })
    }
    ...
    private fun handleScanResult(result: ScanResult) {
        ...
        val dbg = try { com.campusmesh.android.ui.debug.DebugSettingsManager.getInstance() } catch (_: Exception) { null }
