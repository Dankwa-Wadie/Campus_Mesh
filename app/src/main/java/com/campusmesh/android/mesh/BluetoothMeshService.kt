...
import com.campusmesh.android.protocol.MessagePadding
import com.campusmesh.android.model.RoutedPacket
import com.campusmesh.android.model.IdentityAnnouncement
import com.campusmesh.android.model.NoisePayload
import com.campusmesh.android.model.NoisePayloadType
...
import com.campusmesh.android.model.RequestSyncPacket
import com.campusmesh.android.sync.GossipSyncManager
import com.campusmesh.android.util.toHexString
...
class BluetoothMeshService(private val context: Context) : TransportBridgeService.TransportLayer {
    ...
    companion object {
        ...
        private val MAX_TTL: UByte = com.campusmesh.android.util.AppConstants.MESSAGE_TTL_HOPS
    }
    ...
    private val serviceNotificationManager = com.campusmesh.android.ui.NotificationManager(
        context.applicationContext,
        androidx.core.app.NotificationManagerCompat.from(context.applicationContext),
        com.campusmesh.android.util.NotificationIntervalManager()
    )
        ...
        gossipSyncManager = GossipSyncManager(
            ...
            configProvider = object : GossipSyncManager.ConfigProvider {
                override fun seenCapacity(): Int = try {
                    com.campusmesh.android.ui.debug.DebugPreferenceManager.getSeenPacketCapacity(500)
                } catch (_: Exception) { 500 }

                override fun gcsMaxBytes(): Int = try {
                    com.campusmesh.android.ui.debug.DebugPreferenceManager.getGcsMaxFilterBytes(400)
                } catch (_: Exception) { 400 }

                override fun gcsTargetFpr(): Double = try {
                    com.campusmesh.android.ui.debug.DebugPreferenceManager.getGcsFprPercent(1.0) / 100.0
                } catch (_: Exception) { 0.01 }
            }
        )

        com.campusmesh.android.service.MeshServiceHolder.setGossipManager(gossipSyncManager) { packet ->
    ...
    private fun isBleTransportEnabled(): Boolean {
        return try {
            com.campusmesh.android.ui.debug.DebugSettingsManager.getInstance().bleEnabled.value
        } catch (_: Exception) {
            try { com.campusmesh.android.ui.debug.DebugPreferenceManager.getBleEnabled(true) } catch (_: Exception) { true }
        }
    }
    ...
    private fun setupDelegates() {
        ...
        peerManager.delegate = object : PeerManagerDelegate {
            override fun onPeerListUpdated(peerIDs: List<String>) {
                ...
                try { com.campusmesh.android.services.AppStateStore.setTransportPeers("BLE", peerIDs) } catch (_: Exception) { }
            ...
            override fun onPeerRemoved(peerID: String) {
                ...
                try { com.campusmesh.android.services.meshgraph.MeshGraphService.getInstance().removePeer(peerID) } catch (_: Exception) { }
        ...
        messageHandler.delegate = object : MessageHandlerDelegate {
            ...
            override fun updatePeerIDBinding(newPeerID: String, nickname: String,
                ...
                try {
                    com.campusmesh.android.favorites.FavoritesPersistenceService.shared.findNostrPubkey(publicKey)?.let { npub ->
                        com.campusmesh.android.favorites.FavoritesPersistenceService.shared.updateNostrPublicKeyForPeerID(newPeerID, npub)
                    }
                } catch (_: Exception) { }
                ...
                try {
                    when {
                        message.isPrivate -> {
                            ...
                            if (peer.isNotEmpty()) com.campusmesh.android.services.AppStateStore.addPrivateMessage(peer, message)
                        }
                        message.channel != null -> {
                            com.campusmesh.android.services.AppStateStore.addChannelMessage(message.channel!!, message)
                        }
                        else -> {
                            com.campusmesh.android.services.AppStateStore.addPublicMessage(message)
                        }
                    }
                } catch (_: Exception) { }
                ...
                if (delegate == null && message.isPrivate) {
                    try {
                        ...
                        if (senderPeerID != null) {
                            ...
                            val preview = com.campusmesh.android.ui.NotificationTextUtils.buildPrivateMessagePreview(message)
            ...
            override fun handleAnnounce(routed: RoutedPacket) {
                serviceScope.launch {
                    ...
                    if (deviceAddress != null && pid != null) {
                        ...
                        val isDirect = routed.packet.ttl == com.campusmesh.android.util.AppConstants.MESSAGE_TTL_HOPS
        ...
        override fun onPacketReceived(packet: BitchatPacket, peerID: String, device: android.bluetooth.BluetoothDevice?) {
            ...
            try {
                com.campusmesh.android.ui.debug.DebugSettingsManager.getInstance().logIncoming(
                    packet = packet,
                    fromPeerID = peerID,
                    fromNickname = null,
            ...
            override fun onDeviceConnected(device: android.bluetooth.BluetoothDevice) {
                ...
                try {
                    ...
                    com.campusmesh.android.ui.debug.DebugSettingsManager.getInstance()
    ...
    fun startServices() {
        ...
        if (!isBleTransportEnabled()) {
            ...
            com.campusmesh.android.service.MeshServiceHolder.stopSharedGossip("BLE")
            try { com.campusmesh.android.services.AppStateStore.clearTransportPeers("BLE") } catch (_: Exception) { }
            try { com.campusmesh.android.services.AppStateStore.clearTransportDirectPeers("BLE") } catch (_: Exception) { }
            return
        }
        if (terminated) {
        ...
        if (connectionManager.startServices()) {
            ...
            com.campusmesh.android.service.MeshServiceHolder.startSharedGossip("BLE")
     ...
     */
    fun sendFileBroadcast(file: com.campusmesh.android.model.BitchatFilePacket) {
        try {
     ...
     */
    fun sendFilePrivate(recipientPeerID: String, file: com.campusmesh.android.model.BitchatFilePacket) {
        try {
            ...
            serviceScope.launch {
                ...
                if (encryptionService.hasEstablishedSession(recipientPeerID)) {
                    try {
                        ...
                        val noisePayload = com.campusmesh.android.model.NoisePayload(
                            type = com.campusmesh.android.model.NoisePayloadType.FILE_TRANSFER,
                            data = filePayload
                        )
                        ...
                        val packet = BitchatPacket(
                            ...
                            payload = encrypted,
                            signature = null,
                            ttl = com.campusmesh.android.util.AppConstants.MESSAGE_TTL_HOPS
                        )
        ...
        serviceScope.launch {
            ...
            if (encryptionService.hasEstablishedSession(recipientPeerID)) {
                try {
                    ...
                    val privateMessage = com.campusmesh.android.model.PrivateMessagePacket(
                    ...
                    val messagePayload = com.campusmesh.android.model.NoisePayload(
                        type = com.campusmesh.android.model.NoisePayloadType.PRIVATE_MESSAGE,
                        data = tlvData
                    )
    ...
    fun sendReadReceipt(messageID: String, recipientPeerID: String, readerNickname: String) {
        serviceScope.launch {
            ...
            val geo = runCatching { com.campusmesh.android.services.MessageRouter.tryGetInstance() }.getOrNull()
            val isGeoAlias = try {
                val map = com.campusmesh.android.nostr.GeohashAliasRegistry.snapshot()
                map.containsKey(recipientPeerID)
            } catch (_: Exception) { false }
            if (isGeoAlias && geo != null) {
                geo.sendReadReceipt(com.campusmesh.android.model.ReadReceipt(messageID), recipientPeerID)
                return@launch
            }

            try {
                // Avoid duplicate read receipts: check persistent store first
                val seenStore = try { com.campusmesh.android.services.SeenMessageStore.getInstance(context.applicationContext) } catch (_: Exception) { null }
                ...
                val readReceiptPayload = com.campusmesh.android.model.NoisePayload(
                    type = com.campusmesh.android.model.NoisePayloadType.READ_RECEIPT,
                ...
                val packet = BitchatPacket(
                    ...
                    payload = encrypted,
                    signature = null,
                    ttl = com.campusmesh.android.util.AppConstants.MESSAGE_TTL_HOPS // Same TTL as iOS messageTTL
                )
    ...
    fun sendBroadcastAnnounce() {
        ...
        serviceScope.launch {
            val nickname = try { com.campusmesh.android.services.NicknameProvider.getNickname(context, myPeerID) } catch (_: Exception) { myPeerID }
            ...
            try {
                ...
                if (directPeers.isNotEmpty()) {
                    val gossip = com.campusmesh.android.services.meshgraph.GossipTLV.encodeNeighbors(directPeers)
                    tlvPayload = tlvPayload + gossip
                }
                // Always update our own node in the mesh graph with the neighbor list we used
                try {
                    com.campusmesh.android.services.meshgraph.MeshGraphService.getInstance()
    ...
    private fun getDirectPeerIDsForGossip(): List<String> {
        return try {
            ...
            try { com.campusmesh.android.services.AppStateStore.setTransportDirectPeers("BLE", direct) } catch (_: Exception) { }
            val union = try {
                com.campusmesh.android.services.AppStateStore.getDirectPeers().ifEmpty { direct }
     ...
     */
    fun getSessionState(peerID: String): com.campusmesh.android.noise.NoiseSession.NoiseSessionState {
        ...
        return try {
            ...
            val withRoute = try {
                ...
                if (rec != null && !rec.contentEquals(SpecialRecipients.BROADCAST)) {
                    ...
                    val path = com.campusmesh.android.services.meshgraph.RoutePlanner.shortestPath(myPeerID, dest)
