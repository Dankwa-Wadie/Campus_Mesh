package com.campusmesh.android.features.file
...
object FileUtils {
    ...
    fun saveIncomingFile(
        context: Context,
        file: com.campusmesh.android.model.BitchatFilePacket
    ): String {
     ...
     */
    fun messageTypeForMime(mime: String): com.campusmesh.android.model.BitchatMessageType {
        val lower = mime.lowercase()
        return when {
            lower.startsWith("image/") -> com.campusmesh.android.model.BitchatMessageType.Image
            lower.startsWith("audio/") -> com.campusmesh.android.model.BitchatMessageType.Audio
            else -> com.campusmesh.android.model.BitchatMessageType.File
        }
    }
