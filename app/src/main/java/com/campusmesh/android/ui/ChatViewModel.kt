...
import com.campusmesh.android.favorites.FavoritesPersistenceService
import kotlinx.coroutines.flow.StateFlow
import kotlinx.coroutines.flow.MutableStateFlow
import kotlinx.coroutines.flow.asStateFlow
import com.campusmesh.android.mesh.BluetoothMeshDelegate
import com.campusmesh.android.mesh.BluetoothMeshService
import com.campusmesh.android.mesh.MeshService
import com.campusmesh.android.service.MeshServiceHolder
import com.campusmesh.android.model.BitchatMessage
import com.campusmesh.android.model.BitchatMessageType
import com.campusmesh.android.nostr.NostrIdentityBridge
import com.campusmesh.android.protocol.BitchatPacket


import kotlinx.coroutines.launch
import com.campusmesh.android.util.NotificationIntervalManager
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch
import java.util.Date
import kotlin.random.Random
import com.campusmesh.android.services.VerificationService
import com.campusmesh.android.identity.SecureIdentityStateManager
import com.campusmesh.android.noise.NoiseSession
import com.campusmesh.android.nostr.GeohashAliasRegistry
import com.campusmesh.android.util.dataFromHexString
import com.campusmesh.android.util.hexEncodedString
...
class ChatViewModel(
    ...
    private val debugManager by lazy { try { com.campusmesh.android.ui.debug.DebugSettingsManager.getInstance() } catch (e: Exception) { null } }
    ...
    val role: StateFlow<String> = state.role
    ...
    val selectedLocationChannel: StateFlow<com.campusmesh.android.geohash.ChannelID?> = state.selectedLocationChannel
    ...
    fun getMeshPeerInfo(peerID: String): com.campusmesh.android.mesh.PeerInfo? = mesh.getPeerInfo(peerID)
    ...
    init {
        ...
        viewModelScope.launch {
            try { com.campusmesh.android.services.AppStateStore.peers.collect { peers ->
                state.setConnectedPeers(peers)
                state.setIsConnected(peers.isNotEmpty())
            } } catch (_: Exception) { }
        }
        viewModelScope.launch {
            try { com.campusmesh.android.services.AppStateStore.publicMessages.collect { msgs ->
                // Source of truth is AppStateStore; replace to avoid duplicate keys in LazyColumn
                state.setMessages(msgs)
            } } catch (_: Exception) { }
        }
        viewModelScope.launch {
            try { com.campusmesh.android.services.AppStateStore.privateMessages.collect { byPeer ->
                ...
                try {
                    val seen = com.campusmesh.android.services.SeenMessageStore.getInstance(getApplication())
        ...
        viewModelScope.launch {
            try { com.campusmesh.android.services.AppStateStore.channelMessages.collect { byChannel ->
                // Replace with store snapshot
        ...
        viewModelScope.launch {
            com.campusmesh.android.mesh.TransferProgressManager.events.collect { evt ->
    ...
    private fun loadAndInitialize() {
        ...
        viewModelScope.launch {
            com.campusmesh.android.ui.debug.DebugSettingsManager.getInstance().debugMessages.collect { msgs ->
                if (com.campusmesh.android.ui.debug.DebugSettingsManager.getInstance().verboseLoggingEnabled.value) {
                    ...
                    if (selectedLocation is com.campusmesh.android.geohash.ChannelID.Mesh) {
        ...
        com.campusmesh.android.favorites.FavoritesPersistenceService.initialize(getApplication())
        ...
        try {
            val nostrTransport = com.campusmesh.android.nostr.NostrTransport.getInstance(getApplication())
    ...
    private fun ensureGeohashDMSubscriptionIfNeeded(convKey: String) {
        try {
            ...
            val repo = repoField.get(geohashViewModel) as com.campusmesh.android.nostr.GeohashRepository
            ...
            if (!gh.isNullOrEmpty()) {
                ...
                val subMgr = subMgrField.get(geohashViewModel) as com.campusmesh.android.nostr.NostrSubscriptionManager
                val identity = com.campusmesh.android.nostr.NostrIdentityBridge.deriveIdentity(gh, getApplication())
                val subId = "geo-dm-$gh"
                ...
                if (currentId != subId) {
                    ...
                    subMgr.subscribeGiftWraps(
                        ...
                        handler = { event ->
                            ...
                            val dmHandler = dmHandlerField.get(geohashViewModel) as com.campusmesh.android.nostr.NostrDirectMessageHandler
    ...
    fun openLatestUnreadPrivateChat() {
        try {
            ...
            val openPeer: String = if (targetKey.startsWith("nostr_")) {
                ...
                val canonical = com.campusmesh.android.services.ConversationAliasResolver.resolveCanonicalPeerID(
                    ...
                    nostrPubHexForAlias = { alias -> com.campusmesh.android.nostr.GeohashAliasRegistry.get(alias) },
                    findNoiseKeyForNostr = { key -> com.campusmesh.android.favorites.FavoritesPersistenceService.shared.findNoiseKey(key) }
                )
                canonical ?: targetKey
            }
    ...
    fun sendMessage(content: String) {
        ...
        if (content.startsWith("/")) {
            ...
            commandProcessor.processCommand(content, mesh, mesh.myPeerID, { messageContent, mentions, channel ->
                if (selectedLocationForCommand is com.campusmesh.android.geohash.ChannelID.Location) {
        ...
        if (selectedPeer != null) {
            ...
            selectedPeer = com.campusmesh.android.services.ConversationAliasResolver.resolveCanonicalPeerID(
            ...
            privateChatManager.sendPrivateMessage(
                ...
                val router = com.campusmesh.android.services.MessageRouter.getInstance(getApplication(), mesh)
                router.sendPrivate(messageContent, peerID, recipientNicknameParam, messageId)
            }
        } else {
            // Check if we're in a location channel
            val selectedLocationChannel = state.selectedLocationChannel.value
            if (selectedLocationChannel is com.campusmesh.android.geohash.ChannelID.Location) {
                ...
                // Prepare channel prefixing or official announcement signatures
                val payloadToSend = if (currentChannelValue == "#gctu-announcements" || content.startsWith("/alert ")) {
                    val msgText = if (content.startsWith("/alert ")) content.removePrefix("/alert ").trim() else content
                    val encryptionService = com.campusmesh.android.crypto.EncryptionService(getApplication())
                    val mySigningPubKey = encryptionService.getSigningPublicKey() ?: ByteArray(0)
                    val mySigningPubKeyBase64 = android.util.Base64.encodeToString(mySigningPubKey, android.util.Base64.NO_WRAP)
                    
                    val mockCert = com.campusmesh.android.crypto.RoleAttestationManager.RoleCertificate(
                        subjectPublicKey = mySigningPubKeyBase64,
                        role = state.getRoleValue() ?: "Student",
                        name = state.getNicknameValue() ?: "Lecturer",
                        signature = "aGFja2F0aG9uX2FkbWluX3NpZ25hdHVyZV9tb2NrX3NhZmFyaV9wcmVzZW50YXRpb24="
                    )
                    
                    val timestamp = System.currentTimeMillis()
                    val signingData = "$msgText|$timestamp".toByteArray(java.nio.charset.StandardCharsets.UTF_8)
                    val signatureBytes = encryptionService.signData(signingData) ?: ByteArray(0)
                    val signatureBase64 = android.util.Base64.encodeToString(signatureBytes, android.util.Base64.NO_WRAP)
                    
                    val signedAnnounce = com.campusmesh.android.crypto.RoleAttestationManager.SignedAnnouncement(
                        content = msgText,
                        timestamp = timestamp,
                        certificate = mockCert,
                        messageSignature = signatureBase64
                    )
                    
                    val jsonPayload = com.google.gson.Gson().toJson(signedAnnounce)
                    if (content.startsWith("/alert ")) {
                        "/alert $jsonPayload"
                    } else {
                        "[📢#gctu-announcements] $jsonPayload"
                    }
                } else if (currentChannelValue != null && currentChannelValue != "#general") {
                    "[$currentChannelValue] $content"
                } else {
                    content
                }

                val isAlert = content.startsWith("/alert ")
                val targetChannel = if (isAlert) "#gctu-announcements" else currentChannelValue
                val cleanContent = if (isAlert) content.removePrefix("/alert ").trim() else content
                ...
                if (targetChannel != null) {
                    channelManager.addChannelMessage(targetChannel, message, mesh.myPeerID)

                    // Check if encrypted channel
                    if (channelManager.hasChannelKey(targetChannel)) {
                        channelManager.sendEncryptedChannelMessage(
                            ...
                            onEncryptedPayload = { encryptedData ->
                                mesh.sendMessage(payloadToSend, mentions, targetChannel)
                            },
                            onFallback = {
                                mesh.sendMessage(payloadToSend, mentions, targetChannel)
                            }
                    ...
                    mesh.sendMessage(payloadToSend, mentions, null)
                }
            }
        }
    }
    ...
    fun toggleFavorite(peerID: String) {
        ...
        try {
            ...
            if (peerInfo?.noisePublicKey != null) {
                ...
                if (peerID.length == 64 && peerID.matches(Regex("^[0-9a-fA-F]+$"))) {
                    try {
                        ...
                        val rel = com.campusmesh.android.favorites.FavoritesPersistenceService.shared.getFavoriteStatus(noiseKey!!)
            ...
            if (noiseKey != null) {
                ...
                val identityManager = com.campusmesh.android.identity.SecureIdentityStateManager(getApplication())
                ...
                com.campusmesh.android.favorites.FavoritesPersistenceService.shared.updateFavoriteStatus(
                ...
                try {
                    com.campusmesh.android.services.MessageRouter
    ...
    fun panicClearAllData() {
        ...
        try {
            com.campusmesh.android.services.SeenMessageStore.getInstance(getApplication()).clear()
        } catch (_: Exception) { }
        ...
        com.campusmesh.android.features.file.FileUtils.clearAllMedia(getApplication())
        ...
        try {
            ...
            try {
                val store = com.campusmesh.android.geohash.GeohashBookmarksStore.getInstance(getApplication())
                store.clearAll()
            } catch (_: Exception) { }

            try {
                val locationManager = com.campusmesh.android.geohash.LocationChannelManager.getInstance(getApplication())
    ...
    fun selectLocationChannel(channel: com.campusmesh.android.geohash.ChannelID) {
