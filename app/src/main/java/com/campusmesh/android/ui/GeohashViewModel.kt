...
import com.campusmesh.android.nostr.GeohashMessageHandler
import com.campusmesh.android.nostr.GeohashRepository
import com.campusmesh.android.nostr.NostrDirectMessageHandler
import com.campusmesh.android.nostr.NostrIdentityBridge
import com.campusmesh.android.nostr.NostrProtocol
import com.campusmesh.android.nostr.NostrRelayManager
import com.campusmesh.android.nostr.NostrSubscriptionManager
import com.campusmesh.android.nostr.PoWPreferenceManager
import com.campusmesh.android.nostr.GeohashAliasRegistry
import com.campusmesh.android.nostr.GeohashConversationRegistry
...
class GeohashViewModel(
    ...
    private var locationChannelManager: com.campusmesh.android.geohash.LocationChannelManager? = null
    ...
    fun initialize() {
        ...
        try {
            locationChannelManager = com.campusmesh.android.geohash.LocationChannelManager.getInstance(getApplication())
            ...
            state.setSelectedLocationChannel(com.campusmesh.android.geohash.ChannelID.Mesh)
    ...
    fun sendGeohashMessage(content: String, channel: com.campusmesh.android.geohash.GeohashChannel, myPeerID: String, nickname: String?) {
        viewModelScope.launch {
            try {
                ...
                val localMsg = com.campusmesh.android.model.BitchatMessage(
                    id = tempId,
                ...
                if (startedMining) {
                    com.campusmesh.android.ui.PoWMiningTracker.startMiningMessage(tempId)
                }
                try {
                    ...
                    if (startedMining) {
                        com.campusmesh.android.ui.PoWMiningTracker.stopMiningMessage(tempId)
                    }
                }
            } catch (e: Exception) {
    ...
    fun startGeohashDM(pubkeyHex: String, onStartPrivateChat: (String) -> Unit) {
        ...
        val gh = (current as? com.campusmesh.android.geohash.ChannelID.Location)?.channel?.geohash
        if (!gh.isNullOrEmpty()) {
    ...
    fun blockUserInGeohash(targetNickname: String) {
        ...
        if (pubkey != null) {
            ...
            val sysMsg = com.campusmesh.android.model.BitchatMessage(
                sender = "system",
    ...
    private fun switchLocationChannel(channel: com.campusmesh.android.geohash.ChannelID?) {
        ...
        when (channel) {
            is com.campusmesh.android.geohash.ChannelID.Mesh -> {
            ...
            is com.campusmesh.android.geohash.ChannelID.Location -> {
