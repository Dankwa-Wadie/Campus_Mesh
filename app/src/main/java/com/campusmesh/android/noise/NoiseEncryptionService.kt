package com.campusmesh.android.noise

import android.content.Context
import android.util.Log
import com.campusmesh.android.identity.SecureIdentityStateManager
import com.campusmesh.android.mesh.PeerFingerprintManager
import com.campusmesh.android.noise.southernstorm.protocol.Noise
...
class NoiseEncryptionService(private val context: Context) {
    ...
    companion object {
        ...
        private const val REKEY_TIME_LIMIT = com.campusmesh.android.util.AppConstants.Noise.REKEY_TIME_LIMIT_MS // 1 hour (same as iOS)
        private const val REKEY_MESSAGE_LIMIT = com.campusmesh.android.util.AppConstants.Noise.REKEY_MESSAGE_LIMIT_ENCRYPTION // 1k messages (matches iOS) (same as iOS)
    }
    ...
    private fun generateKeyPair(): Pair<ByteArray, ByteArray> {
        try {
            val dhState = com.campusmesh.android.noise.southernstorm.protocol.Noise.createDH("25519")
     ...
     */
    fun signPacket(packet: com.campusmesh.android.protocol.BitchatPacket): com.campusmesh.android.protocol.BitchatPacket? {
     ...
     */
    fun verifyPacketSignature(packet: com.campusmesh.android.protocol.BitchatPacket, publicKey: ByteArray): Boolean {
