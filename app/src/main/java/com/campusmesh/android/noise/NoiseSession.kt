...
import com.campusmesh.android.noise.southernstorm.protocol.*
...
class NoiseSession(
    ...
    companion object {
        ...
        private const val REKEY_TIME_LIMIT = com.campusmesh.android.util.AppConstants.Noise.REKEY_TIME_LIMIT_MS // 1 hour
        private const val REKEY_MESSAGE_LIMIT = com.campusmesh.android.util.AppConstants.Noise.REKEY_MESSAGE_LIMIT_SESSION // 10k messages
        ...
        private const val MAX_PAYLOAD_SIZE = com.campusmesh.android.util.AppConstants.Noise.MAX_PAYLOAD_SIZE_BYTES
        ...
        private const val HIGH_NONCE_WARNING_THRESHOLD = com.campusmesh.android.util.AppConstants.Noise.HIGH_NONCE_WARNING_THRESHOLD
