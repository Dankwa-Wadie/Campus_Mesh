...
import com.campusmesh.android.onboarding.BluetoothCheckScreen
import com.campusmesh.android.onboarding.BluetoothStatus
import com.campusmesh.android.onboarding.BluetoothStatusManager
import com.campusmesh.android.onboarding.BatteryOptimizationManager
import com.campusmesh.android.onboarding.BatteryOptimizationPreferenceManager
import com.campusmesh.android.onboarding.BatteryOptimizationScreen
import com.campusmesh.android.onboarding.BatteryOptimizationStatus
import com.campusmesh.android.onboarding.BackgroundLocationPermissionScreen
import com.campusmesh.android.onboarding.InitializationErrorScreen
import com.campusmesh.android.onboarding.InitializingScreen
import com.campusmesh.android.onboarding.LocationCheckScreen
import com.campusmesh.android.onboarding.LocationStatus
import com.campusmesh.android.onboarding.LocationStatusManager
import com.campusmesh.android.onboarding.OnboardingCoordinator
import com.campusmesh.android.onboarding.OnboardingState
import com.campusmesh.android.onboarding.PermissionExplanationScreen
import com.campusmesh.android.onboarding.PermissionManager
import com.campusmesh.android.ui.ChatScreen
import com.campusmesh.android.ui.ChatViewModel
import com.campusmesh.android.ui.OrientationAwareActivity
import com.campusmesh.android.ui.theme.BitchatTheme
import com.campusmesh.android.wifiaware.WifiAwareController
import com.campusmesh.android.nostr.PoWPreferenceManager
...
class MainActivity : OrientationAwareActivity() {
    ...
    private val forceFinishReceiver = object : android.content.BroadcastReceiver() {
        override fun onReceive(context: android.content.Context, intent: android.content.Intent) {
            if (intent.action == com.campusmesh.android.util.AppConstants.UI.ACTION_FORCE_FINISH) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val filter = android.content.IntentFilter(com.campusmesh.android.util.AppConstants.UI.ACTION_FORCE_FINISH)
        if (android.os.Build.VERSION.SDK_INT >= 33) {
            registerReceiver(
                forceFinishReceiver,
                filter,
                com.campusmesh.android.util.AppConstants.UI.PERMISSION_FORCE_FINISH,
                null,
        ...
        com.campusmesh.android.service.AppShutdownCoordinator.cancelPendingShutdown()
        ...
        meshService = com.campusmesh.android.service.MeshServiceHolder.getOrCreate(applicationContext)
        unifiedMeshService = com.campusmesh.android.service.MeshServiceHolder.getUnifiedOrCreate(applicationContext)
    ...
    private fun checkBluetoothAndProceed() {
        ...
        val bleRequired = try { com.campusmesh.android.ui.debug.DebugPreferenceManager.getBleEnabled(true) } catch (_: Exception) { true }
        if (!bleRequired) {
        ...
        lifecycleScope.launch {
            ...
            if (permissionManager.isFirstTimeLaunch()) {
                ...
                if (permissionManager.needsBackgroundLocationPermission() &&
                    ...
                    !com.campusmesh.android.onboarding.BackgroundLocationPreferenceManager.isSkipped(this@MainActivity)
                ) {
                    mainViewModel.updateOnboardingState(OnboardingState.BACKGROUND_LOCATION_EXPLANATION)
                } else {
    ...
    private fun handleLocationEnabled() {
        ...
        com.campusmesh.android.wifiaware.WifiAwareController.startIfPossible()
        checkBatteryOptimizationAndProceed()
    }
    ...
    private fun handleOnboardingComplete() {
        ...
        val bleRequired2 = try { com.campusmesh.android.ui.debug.DebugPreferenceManager.getBleEnabled(true) } catch (_: Exception) { true }
        when {
    ...
    private fun startMeshForegroundServiceBestEffort() {
        ...
        try {
            com.campusmesh.android.service.MeshForegroundService.start(applicationContext)
    ...
    private fun initializeApp() {
        ...
        lifecycleScope.launch {
            try {
                ...
                com.campusmesh.android.nostr.LocationNotesInitializer.initialize(this@MainActivity)
    ...
    private fun handleNotificationIntent(intent: Intent) {
        val shouldOpenPrivateChat = intent.getBooleanExtra(
            com.campusmesh.android.ui.NotificationManager.EXTRA_OPEN_PRIVATE_CHAT, 
            false
        )
        
        val shouldOpenGeohashChat = intent.getBooleanExtra(
            com.campusmesh.android.ui.NotificationManager.EXTRA_OPEN_GEOHASH_CHAT,
            false
        )
        
        when {
            shouldOpenPrivateChat -> {
                val peerID = intent.getStringExtra(com.campusmesh.android.ui.NotificationManager.EXTRA_PEER_ID)
                val senderNickname = intent.getStringExtra(com.campusmesh.android.ui.NotificationManager.EXTRA_SENDER_NICKNAME)
            ...
            shouldOpenGeohashChat -> {
                val geohash = intent.getStringExtra(com.campusmesh.android.ui.NotificationManager.EXTRA_GEOHASH)
                ...
                if (geohash != null) {
                    ...
                    val level = when (geohash.length) {
                        7 -> com.campusmesh.android.geohash.GeohashChannelLevel.BLOCK
                        6 -> com.campusmesh.android.geohash.GeohashChannelLevel.NEIGHBORHOOD
                        5 -> com.campusmesh.android.geohash.GeohashChannelLevel.CITY
                        4 -> com.campusmesh.android.geohash.GeohashChannelLevel.PROVINCE
                        2 -> com.campusmesh.android.geohash.GeohashChannelLevel.REGION
                        else -> com.campusmesh.android.geohash.GeohashChannelLevel.CITY // Default fallback
                    }
                    val geohashChannel = com.campusmesh.android.geohash.GeohashChannel(level, geohash)
                    val channelId = com.campusmesh.android.geohash.ChannelID.Location(geohashChannel)
