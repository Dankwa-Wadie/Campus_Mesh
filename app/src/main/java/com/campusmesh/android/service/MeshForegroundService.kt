package com.campusmesh.android.service
...
class MeshForegroundService : Service() {
    ...
    companion object {
        ...
        const val ACTION_START = "com.campusmesh.android.service.START"
        const val ACTION_STOP = "com.campusmesh.android.service.STOP"
        const val ACTION_QUIT = "com.campusmesh.android.service.QUIT"
        const val ACTION_UPDATE_NOTIFICATION = "com.campusmesh.android.service.UPDATE_NOTIFICATION"
        const val ACTION_NOTIFICATION_PERMISSION_GRANTED = "com.campusmesh.android.action.NOTIFICATION_PERMISSION_GRANTED"
    ...
    private val unifiedMeshService: com.campusmesh.android.mesh.MeshService?
    ...
    override fun onCreate() {
        ...
        // Start Ktor Web Gateway & Wifi Hotspot
        try {
            com.campusmesh.android.net.KtorGatewayManager.start(applicationContext)
            com.campusmesh.android.net.WifiHotspotManager.startHotspotAndMdns(applicationContext)
        } catch (e: Exception) {
            Log.e("MeshForegroundService", "Failed to start Ktor Gateway or Hotspot: ${e.message}")
        }
    }
    ...
    private fun ensureMeshStarted() {
        ...
        val bleEnabled = try {
            com.campusmesh.android.ui.debug.DebugPreferenceManager.getBleEnabled(true)
        } catch (_: Exception) {
            true
        }
        if (!bleEnabled) {
    ...
    override fun onDestroy() {
        updateJob?.cancel()
        updateJob = null
        // Stop Ktor Web Gateway & Wifi Hotspot
        try {
            com.campusmesh.android.net.KtorGatewayManager.stop()
            com.campusmesh.android.net.WifiHotspotManager.stopHotspotAndMdns()
        } catch (e: Exception) {
            Log.e("MeshForegroundService", "Failed to stop Ktor Gateway or Hotspot: ${e.message}")
        }
